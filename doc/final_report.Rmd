...
```
*Table 2: The training and test accuracy scores for the decision tree model used to determine whether an Alberta oil spill incident is caused by equipment failure or operator error.*
