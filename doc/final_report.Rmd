...
As the highest train accuracy was reached at the maximum depth of 4 for the decision tree, we produced the following decision tree with setting the hyperparameter(max_depth) as 4 *(you may need to zoom in to read the details of the tree)*:
